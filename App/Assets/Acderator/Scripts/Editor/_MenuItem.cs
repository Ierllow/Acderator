...
public class _MenuItem
{
    ...
    [MenuItem(SCRIPTABLE_OBJECT_ITEM_NAME_PREFIX + "DebugConfig")] private static void DebugConfigToAsset() => ScriptableObjectUtils.ToAsset<DebugConfig>("Scene/Song/Data");
